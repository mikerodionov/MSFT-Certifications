...
Ingest (IoT devices, Logs, Files, Customer data, Financial transactions, weather data, business apps) > Event Hubs/Azure Blob Storage/IoT Hub > Analyze () > Deliver ()
...
- Security: Allow for more granualr access
